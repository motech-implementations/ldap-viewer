...
public final class MessageHelper {
    ...
    public static void addErrorAttribute(ModelAndView mav, String message, Object... args) {
        mav.getModelMap().put(MESSAGE_ATTRIBUTE, new Message(message, Message.Type.DANGER, args));
    }
